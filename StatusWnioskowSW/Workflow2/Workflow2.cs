    ...
    public sealed partial class Workflow2 : SequentialWorkflowActivity
    {
        ...
        private bool CreateMail(SPListItem partner, SPListItemCollection items)
        {
            ...
            try
            {
                ...
                StringBuilder sb = new StringBuilder(Properties.Resources.HTMLTemplate_StatusWnioskow);
...
//}
//</style>
//</head><body style=""font-family: Arial""><table style=""width: 680px""><tr><td><table style=""width: 100%""><tr><td align=""center"" valign=""middle""><h3>Zestawienie bieżących kontraktów</h3></td><td align=""right""><img alt=""logo"" src=""http://stafix24cdn.blob.core.windows.net/sharedfiles/masterleasingLogo.PNG"" width=""110""></td></tr></table></td></tr><tr><td><table cellpadding=""2"" cellspacing=""1"" class=""style1"" style=""width: 100%; font-size: x-small""><thead style=""background: silver""><tr><td class=""style2"">#</td><td class=""style2"">Klient</td><td class=""style2"">Data zgłoszenia</td><td class=""style2"">Wartość PLN</td><td class=""style2"">Cel finansowania</td><td class=""style2"">Status</td><td class=""style2"">Ustalenia z klientem</td><td class=""style2"">Data następnego kontaktu</td></tr></thead>***rows*** </table></td></tr><tr><td style=""background-color: #DAF6CE""><div style=""background-color: #DAF6CE""><blockquote><p><span style=""font-size: x-small"">Witamy serdecznie</span></p><p style=""font-size: x-small"">Przypominamy, że w ramach oferty kredytowej Master Leasing mamy- <span style=""color: #FF0000"">kredyty obrotowe dla Firm do kwoty 500.000 tys. zł.</span></p><p style=""font-size: x-small"">W zakresie tego produktu Klient może skorzystać z:</p><ul><li style=""font-size: x-small""><span style=""color: #FF0000"">Kredytu obrotowego</span> - udzielanego na okres 3 lat, bez okazywania dodatkowych dokumentów finansowych. Kredyt obrotowy udzielany jest po zbadaniu przez analityka wyłącznie wysokości obrotów w firmie, na podstawie wyciągu z konta firmowego za ostatnie 6 miesięcy, od 01.10.2015 (do 100.000 tys. zł)</li><li style=""font-size: x-small""><span style=""color: #FF0000"">Kredytu inwestycyjnego</span> - udzielanego na okres 6 lat, podobnie jak kredyt obrotowy kredyt inwestycyjny przyznawany jest Klientowi na podstawie analizy finansowej obrotów (do kwoty 200.000 tys. zł)</li><li style=""font-size: x-small""><span style=""color: #FF0000"">Limit w rachunku firmowym</span> – dostęp do tego produktu udzielany na takich samych zasadach jak kredyt obrotowy i inwestycyjny, udzielany na rok, do kwoty 60.000 tys. zł</li></ul><p style=""font-size: x-small"">W ramach oferty kredytowej Klienci Master Leasing mogą korzystać także z:</p><ul><li style=""font-size: x-small""><span style=""color: #FF0000"">Kredytów inwestycyjnych i obrotowych</span> udzielanych <span style=""color: #FF0000"">powyżej kwoty 500.000 tys. zł</span>.- na tej płaszczyźnie współpracujemy z ponad 20-stoma bankami, posiadamy rozwiązania także dla Klientów, którzy mają zaległości w BIK, ZUS, US, pomóc możemy Klientowi także w zakresie restrukturyzacji przedsiębiorstw</li><li style=""font-size: x-small""><span style=""color: #FF0000"">Kredytów hipotecznych</span> – w tym obszarze współpracujemy z 22 bankami, kredytowane cele to: wybudowanie domu, zakup mieszkania, spłata kredytu mieszkaniowego w innym banku, remont, wykup mieszkania, pożyczka hipoteczna, konsolidacja i alokacja kredytu i wiele innych <br><br>W przypadku kredytów hipotecznych brane są pod uwagę dochody pochodzące z różnych źródeł: umowa o pracę, działalność gospodarcza, umowa zlecenie, najem nieruchomości, dochody ze spółek komandytowych.</li></ul><p style=""font-size: x-small"">Zapraszamy Państwa do zapozanania się z naszą nową stroną internetową: <a href=""http://www.masterleasing.pl/""><span style=""color: #FF0000"">masterleasing.pl</span></a></p><p style=""font-size: x-small; text-align: left;"">W przypadku jakichkolwiek pytań służymy pomocą.</p><p style=""font-size: x-small; text-align: right;""><em>Zespół Master Leasing</em></p></blockquote></div></td></tr></table></body>");
